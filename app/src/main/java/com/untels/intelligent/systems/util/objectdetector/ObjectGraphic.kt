...
package com.untels.intelligent.systems.util.objectdetector

import android.graphics.*
import androidx.core.content.res.ResourcesCompat
import com.google.mlkit.vision.objects.DetectedObject
import com.untels.intelligent.systems.R
import com.untels.intelligent.systems.util.graphic.GraphicOverlay
...
class ObjectGraphic constructor(overlay: GraphicOverlay, private val detectedObject: DetectedObject) :
    ...
    private val bold = ResourcesCompat.getFont(applicationContext, R.font.open_sans_bold)
    private val normal = ResourcesCompat.getFont(applicationContext, R.font.open_sans)

    init {
        for (i in 0 until numColors) {
            textPaints[i] = Paint()
            textPaints[i].typeface = normal
            textPaints[i].color = COLORS[i][0]
            textPaints[i].textSize = TEXT_SIZE
            boxPaints[i] = Paint()
            boxPaints[i].typeface = normal
    ...
    override fun draw(canvas: Canvas) {
        ...
        var textWidth =
            textPaints[colorID].measureText("ID: " + detectedObject.trackingId)
    ...
    companion object {
        ...
        private const val LABEL_FORMAT = "%.2f%% de confianza (Indice: %d)"
    }
}
