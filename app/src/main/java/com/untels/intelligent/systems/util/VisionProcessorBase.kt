...
import com.untels.intelligent.systems.model.FrameMetadata
import com.untels.intelligent.systems.util.graphic.GraphicOverlay
import com.untels.intelligent.systems.util.graphic.VisionImageProcessor
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    private fun processImage(
        ...
        val bitmap =
            if (Preference.isCameraLiveViewportEnabled(graphicOverlay.context)) null
            else BitmapUtil.getBitmap(data, frameMetadata)
        requestDetectInImage(
    ...
    override fun processImageProxy(image: ImageProxy, graphicOverlay: GraphicOverlay) {
        ...
        if (!Preference.isCameraLiveViewportEnabled(graphicOverlay.context)) {
