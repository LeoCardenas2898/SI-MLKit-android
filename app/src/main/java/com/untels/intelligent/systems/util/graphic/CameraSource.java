...
package com.untels.intelligent.systems.util.graphic;
...
public class CameraSource {
    ...
    private Camera createCamera() throws IOException {
        ...
        SizePair sizePair = Preference.Companion.getCameraPreviewSizePair(activity, requestedCameraId);
        if (sizePair == null) {
            sizePair =
                    selectSizePair(
                            camera,
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    synchronized (processorLock) {
                        frameProcessor.processByteBuffer(data, new FrameMetadata.Builder()
